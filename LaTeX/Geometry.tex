...
\index{lattice!golden angle divergence}
\begin{theorem}
...
\index{lattice!opposed}
\index{lattice!non-opposed}

\section{Spiral lattices}
\label{sec:spiral}
\index{lattice!spiral}
