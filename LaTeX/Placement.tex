...
\mmafig{Ch8DCApparatus}{Simplified view of Douady and Couder's apparatus for generating phyllotactic patterns. A centrifugal electromagnetic gradient transports ferrofluid dipoles periodically dropped from the central pipette. Redrawn from~\cite{douadyPhyllotaxisDynamicalSelf1996a}.}{1}
