...
Among flowering plants, Fibonacci patterns are also relatively common in the kinds of cacti sold as houseplants in the UK: they can sometimes be seen in, for example the prickly pear. Spurges (\textit{Euphorbiaceae}) are one genus of shrubs which are interesting in demonstrating rising phyllotaxis in a fairly clear way. One of the earliest systematic studies of Fibonacci patterns in England was carried out by the Oxford botanist Arthur Harry Church, and self-published by him from 1904.  Figure~\ref{fig:ChurchEuphorbia} shows the stem of a spurge growing outside his office in the Oxford Botanic Garden.
%
...
\vnmafig{Ch1LinfordPine}{Top: (a) whole pineapple and (b) flattened pineapple skin from~\cite{linfordFruitQualityStudies1933}. Bottom: as (b), but with the centre of each scale numbered in order of height in the photograph, and physically adjacent scales joined by lines; note that the black lines are natural markings on the scales}{1.0}
