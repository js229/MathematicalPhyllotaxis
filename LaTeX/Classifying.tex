...
\mmafig{Txb0506Renormalisation}{A lattice with arbitrary parastichy numbers can be 
	...
	Theorem~\ref{thm:renormalization} inverts this compound of rotation and scaling to compute the a complex number $z_m$ which can multiply the $(0,1)$ gray lattice and retrieve the desired $(m,n)$ lattice. 
}{1}
