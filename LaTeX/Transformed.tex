...
then we will not necessarily see Fibonacci numbers, even in a lattice stretched from one using the golden angle, but in Figure~\ref{fig:Txb0601Transition}, the transformation has been carefully chosen to show a change from  $(3,5)$ through $(5,8)$ to $(8,13)$, and even here there are some intermediate heights at which assigning a parastichy pair at all is not straightforward. 
