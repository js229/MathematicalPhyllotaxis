...
\index{placement model!stacked-disk}
...
\mmafig{Txb1004NonopposedNo}{Non-opposed lattices cannot in general be generated by stacked-disk models. Given the white disks as an initial condition formed from a subset of the non-opposed lattice of Figure~\ref{fig:Txb0503NonOpposed}, a next disk placed according to the lattice would not be the lowest possible. }{1}
...
\label{sec:tilings}
\index{cylindrical lattice!rhombic tiling generalisation}
