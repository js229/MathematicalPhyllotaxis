...
}  \chapter{Statisical phyllotaxis}
  \label{ch:empirical}
%\abstract
\section*{Summary}
{Data collection on the visible patterns of Fibonacci-like phyllotaxis has continued to the present day, although there have as yet been few that combine them with molecular or genetic analyses in the same study.
	%
...
\jpgfig{F0809sweetcorn20191008}{A commercially sold sweetcorn cob, with column patterns showing parastichy lines\index{pairs of parastichy vectors!columnar pair} nearly parallel to the growth axis .}{0.2}
